...
public partial class LightShafts : MonoBehaviour
{
    ...
    [SerializeField] private VisibilityProxy m_VisibilityProxy;
	...
	Mesh m_SpotMesh;
    private Vector3[] m_SpotMeshVertices;
	...
	void InitSpotFrustumMesh()
	{
		...
		if (m_SpotMeshNear != m_SpotNear || m_SpotMeshFar != m_SpotFar || m_SpotMeshAngle != l.spotAngle || m_SpotMeshRange != l.range)
		{
            ...
            m_SpotMeshVertices = (m_SpotMesh.vertices != null && m_SpotMesh.vertices.Length == 8) ? m_SpotMesh.vertices : new Vector3[8];
            m_SpotMeshVertices[0] = new Vector3(-halfwidthfar, -halfwidthfar, far);
            m_SpotMeshVertices[1] = new Vector3(halfwidthfar, -halfwidthfar, far);
            m_SpotMeshVertices[2] = new Vector3(halfwidthfar, halfwidthfar, far);
            m_SpotMeshVertices[3] = new Vector3(-halfwidthfar, halfwidthfar, far);
            m_SpotMeshVertices[4] = new Vector3(-halfwidthnear, -halfwidthnear, near);
            m_SpotMeshVertices[5] = new Vector3(halfwidthnear, -halfwidthnear, near);
            m_SpotMeshVertices[6] = new Vector3(halfwidthnear, halfwidthnear, near);
            m_SpotMeshVertices[7] = new Vector3(-halfwidthnear, halfwidthnear, near);
            m_SpotMesh.vertices = m_SpotMeshVertices;
