...
class LightShaftsEditor extends Editor 
{
    ...
    var visibilityProxy : SerializedProperty;
	...
	function OnEnable () {
	    ...
	    visibilityProxy = so.FindProperty("m_VisibilityProxy");
	...
	function OnInspectorGUI ()
	{
	    ...
	    EditorGUILayout.PropertyField(visibilityProxy, new GUIContent("Visibility proxy"));
